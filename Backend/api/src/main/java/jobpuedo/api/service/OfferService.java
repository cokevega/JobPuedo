...
public class OfferService {
	...
	public List<Offer> findFilteredOffer(OfferSearchedRequest offerSearched) {
		...
		ExampleMatcher matcher = ExampleMatcher.matching();//Filtro de coincidencias para datos String
	...
	public List<Offer> getDashboard(User user) {
		//Si es empresa su dashboard son las ofertas subidas, si es usuario las ofertas a las que está inscrito
	...
	public void deleteDefinitely(Offer offer) {
		//Eliminar oferta definitivamente: eliminar primero los registros huérfano, sus inscripciones
